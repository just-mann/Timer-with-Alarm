...
let setAlarm = () => {
  ...
  alarmDisplay.innerHTML = `<i class="fas fa-bell"></i> ${alarmHour.value} : ${alarmMinutes.value} <i class="fas fa-times-circle text-danger ml-3" id='deleteAlarm' title='or press Esc'></i>`;
